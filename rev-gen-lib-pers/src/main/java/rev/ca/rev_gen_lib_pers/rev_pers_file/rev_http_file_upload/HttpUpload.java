...
public class HttpUpload extends AsyncTask<Void, Integer, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        byte[] fileData1 = getFileDataFromDrawable(context, R.drawable.ic_subdirectory_arrow_right_black_24dp);
        byte[] fileData2 = getFileDataFromDrawable(context, R.drawable.ic_keyboard_arrow_right_black_48dp);
