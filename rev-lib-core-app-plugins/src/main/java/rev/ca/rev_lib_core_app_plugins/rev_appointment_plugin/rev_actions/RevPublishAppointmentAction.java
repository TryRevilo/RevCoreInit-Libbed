package rev.ca.rev_lib_core_app_plugins.rev_appointment_plugin.rev_actions;
...
public class RevPublishAppointmentAction implements IRevPersAction {
    ...
    public Object initRevAction(RevEntity revEntity) {
        ...
        new RevPersLibCreate().revPersRelationship(new RevEntityRelationship("appointment_of", revEntityGUID, revEntity.get_revEntityContainerGUID()));
