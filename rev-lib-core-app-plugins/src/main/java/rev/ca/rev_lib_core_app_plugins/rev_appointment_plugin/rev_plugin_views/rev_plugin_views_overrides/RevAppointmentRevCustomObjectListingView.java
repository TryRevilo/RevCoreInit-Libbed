package rev.ca.rev_lib_core_app_plugins.rev_appointment_plugin.rev_plugin_views.rev_plugin_views_overrides;
...
public class RevAppointmentRevCustomObjectListingView extends AbstractIRevPluggableViews implements IRevObjectListingFooterOptions, IOverrideRevEntityListingView {
    ...
    public RevAppointmentRevCustomObjectListingView(RevVarArgsData revVarArgsData) {
    ...
    public RevEntityListingViewOverrideVOM create_OVERRIDE_ITEM(RevEntity revEntity) {
        ...
        revEntityListingViewOverrideVOM.setOverrideName("rev_appointment");
    ...
    private View getGeneralPointingUpVotes(RevEntity revEntity) {
        ...
        String profileNameTtl = "Appointment";
        ...
        Picasso.get()
                .load(R.drawable.icons8_planner_64_grey)
