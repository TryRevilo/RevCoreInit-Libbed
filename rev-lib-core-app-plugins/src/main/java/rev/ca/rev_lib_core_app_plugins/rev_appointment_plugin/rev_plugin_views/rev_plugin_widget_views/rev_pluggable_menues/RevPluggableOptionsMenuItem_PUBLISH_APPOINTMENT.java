package rev.ca.rev_lib_core_app_plugins.rev_appointment_plugin.rev_plugin_views.rev_plugin_widget_views.rev_pluggable_menues;
...
public class RevPluggableOptionsMenuItem_PUBLISH_APPOINTMENT implements ICreateRevPluggableMenuItem {
    ...
    private String menuItemName = "publish_appointment_menu_item";

    public RevPluggableOptionsMenuItem_PUBLISH_APPOINTMENT(RevVarArgsData revVarArgsData) {
    ...
    public RevPluggableMenuItemVM create_REV_PLUGGABLE_MENU_ITEM_VM() {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                postRVD.setRevViewType("RevCreateAppointmentInputForm");
