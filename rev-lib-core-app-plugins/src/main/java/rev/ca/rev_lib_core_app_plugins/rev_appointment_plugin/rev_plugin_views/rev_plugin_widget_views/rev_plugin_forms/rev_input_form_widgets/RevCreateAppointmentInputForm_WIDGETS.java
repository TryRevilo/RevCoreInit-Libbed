package rev.ca.rev_lib_core_app_plugins.rev_appointment_plugin.rev_plugin_views.rev_plugin_widget_views.rev_plugin_forms.rev_input_form_widgets;
...
public class RevCreateAppointmentInputForm_WIDGETS {
    ...
    public RevCreateAppointmentInputForm_WIDGETS(RevVarArgsData revVarArgsData) {
    ...
    private void revInitFields() {
        revEntityName = revCoreInputFormEditText.getRevEditText_NO_BORDERS_NO_PADDING_TINY_SPACING();
        revEntityName.setHint("Appointment entry item name");

        revEntityDescription = revCoreInputFormEditText.getRevEditText_NO_BORDERS_NO_PADDING_TINY_SPACING();
    ...
    public RevEntity revObjectFormdata() {
        ...
        revObjectEntitySuper.set_revEntitySubType("rev_appointment");
