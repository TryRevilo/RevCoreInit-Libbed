...
public class RevBAGPluggableOptionsMenuContainer implements ICreateRevPluggableOptionsMenu {

    private Context mContext;

    public RevBAGPluggableOptionsMenuContainer(Context mContext) {
    ...
    public RevPluggableOptionsMenuVM revCreateRevPluggableOptionsMenue() {
        ...
        revPluggableOptionsMenuVM.setRevPluggableOptionsMenueName("rev_bag_options_menu");
