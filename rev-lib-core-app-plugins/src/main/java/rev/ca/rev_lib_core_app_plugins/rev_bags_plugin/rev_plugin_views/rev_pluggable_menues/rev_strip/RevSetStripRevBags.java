package rev.ca.rev_lib_core_app_plugins.rev_bags_plugin.rev_plugin_views.rev_pluggable_menues.rev_strip;
...
public class RevSetStripRevBags extends AbstractIRevPluggableViews {

    RevVarArgsData revVarArgsData;
    Context mContext;
    ...
    public RevSetStripRevBags(RevVarArgsData revVarArgsData) {
    ...
    public ImageView getRevStripTab_IV() {
        ...
        stripTabIcon_IV.setImageResource(R.drawable.icons8_safety_collection_place_40);
                ...
                new RevCheckRemoteServerConnAsyncTaskService(new RevCheckRemoteServerConnAsyncTaskService.IRevCheckConnAsync() {
                    ...
                    public void processFinishIRevCheckConnAsync(Boolean output) {
                        if (output && !stripTabIcon_IV.isClickable()) {
                            String apiURL = REV_SESSION_SETTINGS.getRevRemoteServer() + "/api/rev_entity/get_all_rev_entity_type?rev_entity_type=rev_group_entity, rev_object";
                                    ...
                                    if (jsonObject == null || jsonObject.length() == 0) {
                                        ...
                                        for (int i = 0; i < jArr.length(); i++) {
                                            ...
                                            try {
                                                ...
                                                revEntity.set_revPublisherEntity(revEntity);

                                                if (revEntity == null || !revEntity.get_revEntityType().equals("rev_group_entity"))
                                                    continue;
