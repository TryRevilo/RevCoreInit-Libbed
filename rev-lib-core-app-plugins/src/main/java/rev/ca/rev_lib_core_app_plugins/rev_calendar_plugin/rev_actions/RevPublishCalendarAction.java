package rev.ca.rev_lib_core_app_plugins.rev_calendar_plugin.rev_actions;
...
public class RevPublishCalendarAction implements IRevPersAction {
    ...
    public Object initRevAction(RevEntity revEntity) {
        ...
        new RevPersLibCreate().revPersRelationship(new RevEntityRelationship("calendar_of", revEntityGUID, revEntity.get_revEntityContainerGUID()));
