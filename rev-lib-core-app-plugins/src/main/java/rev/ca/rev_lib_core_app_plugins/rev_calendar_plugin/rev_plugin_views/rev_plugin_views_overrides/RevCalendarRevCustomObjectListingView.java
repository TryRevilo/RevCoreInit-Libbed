package rev.ca.rev_lib_core_app_plugins.rev_calendar_plugin.rev_plugin_views.rev_plugin_views_overrides;
...
public class RevCalendarRevCustomObjectListingView extends AbstractIRevPluggableViews implements IRevObjectListingFooterOptions, IOverrideRevEntityListingView {
    ...
    public RevCalendarRevCustomObjectListingView(RevVarArgsData revVarArgsData) {
    ...
    public RevEntityListingViewOverrideVOM create_OVERRIDE_ITEM(RevEntity revEntity) {
        ...
        revEntityListingViewOverrideVOM.setOverrideName("rev_calendar");
    ...
    private View getGeneralPointingUpVotes(RevEntity revEntity) {
        ...
        String profileNameTtl = "Calendar";
        ...
        Picasso.get()
                .load(R.drawable.baseline_calendar_today_black_48dp)
