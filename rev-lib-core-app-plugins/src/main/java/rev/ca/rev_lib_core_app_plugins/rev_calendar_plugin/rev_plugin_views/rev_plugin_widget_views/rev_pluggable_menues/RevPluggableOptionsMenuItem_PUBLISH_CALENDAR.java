...
public class RevPluggableOptionsMenuItem_PUBLISH_CALENDAR implements ICreateRevPluggableMenuItem {
    ...
    private String menuItemName = "publish_calendar_menu_item";

    public RevPluggableOptionsMenuItem_PUBLISH_CALENDAR(RevVarArgsData revVarArgsData) {
    ...
    public RevPluggableMenuItemVM create_REV_PLUGGABLE_MENU_ITEM_VM() {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                postRVD.setRevViewType("RevCreateCalendarInputForm");
