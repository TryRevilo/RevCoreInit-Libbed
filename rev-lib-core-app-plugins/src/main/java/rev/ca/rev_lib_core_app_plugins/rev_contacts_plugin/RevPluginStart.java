package rev.ca.rev_lib_core_app_plugins.rev_contacts_plugin;
...
import rev.ca.rev_lib_core_app_plugins.rev_contacts_plugin.rev_plugin_views.rev_pluggable_menus.RevSetStripRevContacts;
import rev.ca.rev_lib_core_app_plugins.rev_contacts_plugin.rev_plugin_views.rev_plugin_widgets.RevPluggableRevDrawerView;
...
public class RevPluginStart extends AbstractIRevPluginStart {
    ...
    public Map<String, List> I_REV_PLUGGABLE_VIEW_SSERVICES() {
        ...
        createRevMerryllStripMenuViewItem.add(RevSetStripRevContacts.class);

        ArrayList createPluggableRevDrawerMenuView = new ArrayList<>();
        createPluggableRevDrawerMenuView.add(RevPluggableRevDrawerView.class);
