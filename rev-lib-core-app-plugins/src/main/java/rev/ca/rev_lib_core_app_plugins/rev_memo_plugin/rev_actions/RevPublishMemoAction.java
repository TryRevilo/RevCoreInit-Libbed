package rev.ca.rev_lib_core_app_plugins.rev_memo_plugin.rev_actions;
...
public class RevPublishMemoAction implements IRevPersAction {
    ...
    public Object initRevAction(RevEntity revEntity) {
        ...
        new RevPersLibCreate().revPersRelationship(new RevEntityRelationship("memo_of", revEntityGUID, revEntity.get_revEntityContainerGUID()));
