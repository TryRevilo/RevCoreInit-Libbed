...
public class RevPluggableOptionsMenuItem_PUBLISH_MEMO implements ICreateRevPluggableMenuItem {
    ...
    private String menuItemName = "publish_memo_menu_item";

    public RevPluggableOptionsMenuItem_PUBLISH_MEMO(RevVarArgsData revVarArgsData) {
