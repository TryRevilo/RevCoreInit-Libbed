package rev.ca.rev_lib_core_app_plugins.rev_pics_plugin.rev_actions;
...
public class RevPublishPicsAlbumAction implements IRevPersAction {
    ...
    public Object initRevAction(RevEntity revEntity) {
        ...
        new RevPersLibCreate().revPersRelationship(new RevEntityRelationship("picture_of", revEntityGUID, revEntity.get_revEntityContainerGUID()));
