...
public class RevDirectAudioFileSelectPluggableMenuItem implements ICreateRevPluggableMenuItem {
    ...
    public RevDirectAudioFileSelectPluggableMenuItem(RevVarArgsData revVarArgsData) {
    ...
    public String REV_PLUGGABLE_MENU_ITEM_VM_NAME() {
        return "rev_direct_audio_file_select_menu_item";
    }
    ...
    public RevPluggableMenuItemVM create_REV_PLUGGABLE_MENU_ITEM_VM() {
        ...
        Picasso.get()
                .load(R.drawable.ic_audiotrack_black_48dp)
                .resize(imageSize, imageSize)
                .centerCrop()
                .into(photoTab_IV);

        RevPluggableMenuItemVM revPluggableMenuItemVM = new RevPluggableMenuItemVM();
        revPluggableMenuItemVM.setRevPluggableMenuItemName("rev_direct_audio_file_select_menu_item");
