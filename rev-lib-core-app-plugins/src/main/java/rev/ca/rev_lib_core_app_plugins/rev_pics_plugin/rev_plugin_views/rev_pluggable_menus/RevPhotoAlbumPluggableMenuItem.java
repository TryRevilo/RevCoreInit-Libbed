...
public class RevPhotoAlbumPluggableMenuItem implements ICreateRevPluggableMenuItem {
    ...
    public RevPhotoAlbumPluggableMenuItem(RevVarArgsData revVarArgsData) {
    ...
    public RevPluggableMenuItemVM create_REV_PLUGGABLE_MENU_ITEM_VM() {
        ...
        textView.setText("New photo album");
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                revVarArgsData.setRevViewType("RevCreateNewObjectAlbumForm");
                revVarArgsData.setRevContainerEntityGUID(revVarArgsData.getRevContainerEntityGUID());
        ...
        revPluggableMenuItemVM.setRevPluggableMenuItemName("add_rev_photo_album");
        revPluggableMenuItemVM.setRevPluggableMenuName(Arrays.asList("rev_core_gen_publisher_options_menu"));
