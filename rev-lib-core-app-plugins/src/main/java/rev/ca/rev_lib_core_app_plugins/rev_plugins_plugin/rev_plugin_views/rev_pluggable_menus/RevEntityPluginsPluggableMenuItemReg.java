...
public class RevEntityPluginsPluggableMenuItemReg implements ICreateRevPluggableMenuItem {

    private RevVarArgsData revVarArgsData;
    private Context mContext;

    private String menuItemName = "rev_entity_plugins_menu_item";

    public RevEntityPluginsPluggableMenuItemReg(RevVarArgsData revVarArgsData) {
