...
public class RevPluggableOptionsMenuItem_USER_OPTION_MENUE_CONTAINER implements ICreateRevPluggableMenuItem {

    private RevVarArgsData revVarArgsData;

    private String menuItemName = "rev_user_options_menu";

    public RevPluggableOptionsMenuItem_USER_OPTION_MENUE_CONTAINER(RevVarArgsData revVarArgsData) {
    ...
    public List<String> REV_PLUGGABLE_MENU_CONTAINER_NAME() {
        return Arrays.asList("rev_user_options_menu_wrapper_area");
    }
    ...
    public RevPluggableMenuItemVM create_REV_PLUGGABLE_MENU_ITEM_VM() {
        ...
        revPluggableMenuItemVM.setRevPluggableMenuName(Arrays.asList("rev_user_options_menu_holder"));

        if (new RevPluggableOptionsContainerMenuLoader().getOptionsMenu("rev_user_options_menu", revVarArgsData) != null) {
            ...
            revPluggableMenuItemVM.setRevPluggableMenuView(new RevPluggableOptionsContainerMenuLoader().getOptionsMenu("rev_user_options_menu", postRVD));
        }
