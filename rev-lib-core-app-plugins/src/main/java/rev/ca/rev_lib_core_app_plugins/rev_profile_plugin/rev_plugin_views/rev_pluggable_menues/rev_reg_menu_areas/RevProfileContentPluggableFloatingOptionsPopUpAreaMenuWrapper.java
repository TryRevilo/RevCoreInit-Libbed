...
public class RevProfileContentPluggableFloatingOptionsPopUpAreaMenuWrapper implements ICreateRevPluggableOptionsMenu {

    private RevCoreLayoutsLinearLayout revCoreLayoutsLinearLayout;

    public RevProfileContentPluggableFloatingOptionsPopUpAreaMenuWrapper(Context mContext) {
    ...
    public RevPluggableOptionsMenuVM revCreateRevPluggableOptionsMenue() {
        ...
        revPluggableOptionsMenuVM.setRevPluggableOptionsMenueName("rev_profile_content_floating_options_pop_up_wrapper_menu_area");
