...
public class RevCreateNewObjectRevProfilePicsForm implements IRevInputFormView, IRevFileCrawler {
    ...
    public RevCreateNewObjectRevProfilePicsForm(RevVarArgsData revVarArgsData) {
    ...
    public RevEntity createRevInputFormData() {
        ...
        revObjectEntitySuper.set_revEntityType(FeedReaderContract.FeedEntry_REV_OBJECT_ENTITY.TABLE_NAME);
        revObjectEntitySuper.set_revEntitySubType("rev_profile_pics_album");
        ...
        revObjectEntity.set_revObjectName("Rev Profile Pics Album");
        revObjectEntity.set_revObjectDescription("NULL");
    ...
    public RevVarArgsData REV_VAR_ARGS_DATA() {
        ...
        revVarArgsDataMetadataStrings.put("submitFormTtlTxt", "Set up your profile pictures");
    ...
    public LinearLayout genPublisherWrapper_LL() {
        ...
        final RevCreateNewObjectRevProfilePicsForm revPublisher = this;
