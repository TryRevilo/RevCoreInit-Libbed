...
import rev.ca.rev_lib_core_app_plugins.rev_profile_plugin.rev_plugin_views.rev_plugin_forms.rev_plugin_forms_widgets.RevAcademicProfileTypeChooserInputFormWidget;
...
public class RevProfileTypeChooserInputForm_ACADEMIC implements IRevInputFormView {

    private RevVarArgsData revVarArgsData;
    private Context mContext;

    public RevProfileTypeChooserInputForm_ACADEMIC(RevVarArgsData revVarArgsData) {
    ...
    public View createRevInputForm() {
        ...
        return new RevAcademicProfileTypeChooserInputFormWidget(revVarArgsData).getRevBagTypeChooser();
    }
