package rev.ca.rev_lib_core_app_plugins.rev_search_plugin.rev_plugin_views.rev_pluggable_menus;
...
public class RevSearchRevEntityPluggableMenuItemReg implements ICreateRevPluggableMenuItem {

    private RevVarArgsData revVarArgsData;
    private Context mContext;

    private String menuItemName = "rev_search_entity_menu_item";

    public RevSearchRevEntityPluggableMenuItemReg(RevVarArgsData revVarArgsData) {
