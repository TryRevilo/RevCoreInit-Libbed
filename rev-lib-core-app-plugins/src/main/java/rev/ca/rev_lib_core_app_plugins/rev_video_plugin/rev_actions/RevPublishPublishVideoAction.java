package rev.ca.rev_lib_core_app_plugins.rev_video_plugin.rev_actions;
...
public class RevPublishPublishVideoAction implements IRevPersAction {
    ...
    public Object initRevAction(RevEntity revEntity) {
        ...
        new RevPersLibCreate().revPersRelationship(new RevEntityRelationship("video_of", revEntityGUID, revEntity.get_revEntityContainerGUID()));
